...
#mvn -Dohc.version=3.0.1 clean install -pl :org.openhab.binding.shelly karaf:kar clean install
...
#mvn -Dohc.version=3.0.1 clean install -pl :org.openhab.binding.shelly karaf:kar

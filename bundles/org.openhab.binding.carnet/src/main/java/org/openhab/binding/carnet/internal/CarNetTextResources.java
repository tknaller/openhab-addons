...
public class CarNetTextResources {
    ...
    public CarNetTextResources(Bundle bundle, TranslationProvider i18nProvider, LocaleProvider localeProvider) {
        this.bundle = bundle;
    ...
    public String getDefaultText(@Nullable String key) {
        String text = i18nProvider.getText(bundle, key, key, Locale.ENGLISH);

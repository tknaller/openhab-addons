...
import static org.openhab.binding.carnet.internal.api.CarNetApiConstants.CNAPI_BRAND_SKODA;
...
/**
 * {@link CarNetBrandApiSkoda} provides the Skoda specific functions of the API
 *
 * @author Markus Michels - Initial contribution
 */
@NonNullByDefault
public class CarNetBrandApiSkoda extends CarNetApiBase {
    private final Logger logger = LoggerFactory.getLogger(CarNetBrandApiSkoda.class);
    ...
    public CarNetApiProperties getProperties() {
        ...
        properties.brand = CNAPI_BRAND_SKODA;
        properties.xcountry = "CZ";
        properties.apiUrlPrefix = "https://msg.skoda.de/fs-car";
        properties.clientId = "7f045eee-7003-4379-9968-9355ed2adb06%40apps_vw-dilab_com";

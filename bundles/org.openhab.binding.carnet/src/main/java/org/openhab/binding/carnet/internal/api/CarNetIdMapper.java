...
public class CarNetIdMapper {
    ...
    public CarNetIdMapper() {
        ...
        // Doors/trunk
        add("STATE_CONVERTIBLE_TOP", "0x0301050009", "covertableTopState", ITEMT_SWITCH, CHANNEL_GROUP_DOORS);
        ...
        add("SAFETY_STATE_RIGHT_FRONT_DOOR", "0x0301040009", "doorFrontRightSafety", ITEMT_SWITCH, CHANNEL_GROUP_DOORS);
        ...
        add("SAFETY_STATE_LEFT_REAR_DOOR", "0x0301040006", "doorRearLeftSafety", ITEMT_SWITCH, CHANNEL_GROUP_DOORS);
        ...
        add("SAFETY_STATE_RIGHT_REAR_DOOR", "0x030104000C", "doorRearRightSafety", ITEMT_SWITCH, CHANNEL_GROUP_DOORS);

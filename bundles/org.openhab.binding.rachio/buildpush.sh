...
cp target/org.openhab.binding.rachio-2.5.*-SNAPSHOT.jar ~/Dev/myfiles/rachio/
...
cp target/org.openhab.binding.rachio-3.*-SNAPSHOT.jar ~/Dev/myfiles/rachio/

echo Pushing updates
cd ~/Dev/myfiles
./push.sh

cd ~/Dev/openhab-2-5-x/git/openhab-addons/bundles/org.openhab.binding.rachio
